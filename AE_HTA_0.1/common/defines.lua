...
economy = {
	...
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_HI = 0.99,	-- how fast pops are Hired when there is a high demand
	RGO_SUPPLY_DEMAND_FACTOR_HIRE_LO = 0.99,	-- how fast pops are Hired when there is a medium demand
